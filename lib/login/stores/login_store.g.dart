...
mixin _$LoginStore on LoginStoreBase, Store {
  ...
  @override
  Future<FlightUser> isAlreadyAuthenticated() {
  ...
  @override
  Future<void> validateOtpAndLogin(BuildContext context, String smsCode,String mobile) async {
    if (!verify) {
      await Navigator.of(context)
          .push(MaterialPageRoute(builder: (_) => SearchPage()));
    }
    return _$validateOtpAndLoginAsyncAction
        .run(() => super.validateOtpAndLogin(context, smsCode,mobile));
  }
  ...
  String toString() {
    final string =
        'isLoginLoading: ${isLoginLoading.toString()},isOtpLoading: ${isOtpLoading.toString()},loginScaffoldKey: ${loginScaffoldKey.toString()},otpScaffoldKey: ${otpScaffoldKey.toString()},firebaseUser: ${user.toString()}';
    return '{$string}';
  }
}
